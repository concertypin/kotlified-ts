...
export function applyOrNull<T>(
    value: T,
    block: (this: NonNullable<T>) => void
): T | undefined {
...
export function runOrNull<T, R>(
    value: T,
    block: (this: NonNullable<T>) => R
): R | undefined {
...
export function takeIfOrNull<T>(
    value: T,
    predicate: (it: NonNullable<T>) => boolean
): T | undefined {
...
export function takeUnlessExt<T>(
    value: T,
    predicate: (it: T) => boolean
): T | undefined {
...
export function takeUnlessOrNull<T>(
    value: T,
    predicate: (it: NonNullable<T>) => boolean
): T | undefined {
